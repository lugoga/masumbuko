---
title: Visualize raster with leaflet and tmap in R
author: Masumbuko Semba
date: '2020-12-14'
slug: visualize-raster-with-leaflet-and-tmap-in-r
categories: []
tags:
  - chlorophyll
  - Satellite
...
```{r, echo=FALSE}
sst = raster("e:/MatlabWorking/modis_sst_monthly_climatological/sst_climatology_Feb_4km_modis.nc", varname = "sst4")
```
...
sst %>% 
  values() %>% 
  hist(main="Distribution of temperature values", 
     col= "maroon")
```

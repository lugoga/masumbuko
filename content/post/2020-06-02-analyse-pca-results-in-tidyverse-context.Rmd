---
title: Analyse PCA results in tidyverse context
author: Masumbuko Semba
date: '2020-06-02'
slug: analyse-pca-results-in-tidyverse-context
categories: []
tags:
  - PCA
  - tidyverse
...
**broom**  package attempt to bridge the gap from untidy outputs of *predictions* and *estimations* to the tidy data we want to work with. broom is particularly designed to work with Hadley’s **dplyr** package [@dplyr].




When we do PCA, Our focus is centered to explore the;

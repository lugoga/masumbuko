...
Looking on individual profiles, We noticed that the current velocity deviate from what has been reported previously. Figure \@ref(fig:fig7) show most profile along the transect from Lindi to Mafia have current speed above normal except profile measured at location with latitude `r lat[1]` and longitude `r lon[1]` (figure \@ref(fig:fig8)). Because I used relative velocity instead of absolute velocity.

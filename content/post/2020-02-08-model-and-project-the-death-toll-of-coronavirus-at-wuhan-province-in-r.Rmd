...
This tutorial will show you how to scrape that data from html table, which lives in a Wikipedia and download the data for further processing. Let us load the packages we need for the session. I will focus on the Wuhan coronavirus to illustrate the point. 86 people died in a single day in China on Friday 7th, February 2020. The coronavirus death toll has risen to at least 805, and the vast majority have died in mainland China. Globally, the virus has infected more 34,400 people across 28 countries and territories (Figure \@ref(fig:fig0)).
...
ggplot(data = corona, 
  ...
  scale_y_continuous(breaks = seq(100,900,150))+
  cowplot::theme_minimal_grid()+
  theme(panel.grid = element_line(linetype = 3), legend.position = "none")+

...
### Drifter processing
Drifter observations were downloaded from NOAA website as ascii files. The dataset was imported in R using the dplyr's *read_table()* function. Once the dataset was imported, it was manipulated and transformed. The dataset has twelve variables, I eliminated variable that I do not need for this post and kepy five variable---id, longitude, latitude, year, month, day and sst. The observation was later grouped into monsoon seasons. Drifter observation from April-September fell into southeast monsoon season (SE) and those between October-March were placed in the northeast monsoon season. Figure \@ref(fig:pic1) summarizee the main analytical processes envolved in this post.

---
title: Get Global climate and weather data with R
author: Masumbuko Semba
date: '2020-12-30'
slug: get-global-climate-and-weather-data-with-r
categories:
  - Oceanography
tags:
  - Masumbuko Semba
...
To make it easy to access and download, Robert Hijmans [-@raster] developed a `getData` function in **raster** packaged dedicated to dowload these data directly in R. The aim of this post is to illustrate how we can get these dataset in R and use the power of language to do statistics, modelling and plotting. Before we begin our session, let us first load the packages into our session
...
We then use a `plot` function from raster to visulaize the layer
...
bio_clim = read_csv("e:/Data Manipulation/worldClim_bio.csv") 

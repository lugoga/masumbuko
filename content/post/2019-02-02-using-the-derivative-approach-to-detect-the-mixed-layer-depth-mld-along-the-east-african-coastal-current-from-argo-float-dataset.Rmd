...
```{r section, echo=FALSE, fig.cap="Hydrographic section of temperature and salinity", fig.width=6, fig.height=2.5, fig.align="center"}
...
# Conclusion
-@kelley2018r explained that although the mixed-layer depth (MLD) is a parameter of
great interest, there is little agreement on how it should be defined. This is partly
because the most appropriate definition can depend on the scientific application. This is clearly illustrated in figure \@ref(fig:mld-compare) that shows the discrepancy of the two approaches, with the derivative method giving a deeper MLD compared to the criterion method. 

...
```{r, echo=FALSE}
load("e:/Data Manipulation/xtractomatic/aviso_response.RData")
...
Once we have the time geographical domain and the time bound, we can download the gridded sea surface height (ssh) and geostrophic zonal(U) and meridional(Z) currents. Let's start with the zonal currents within the defined domain. We use the `xtracto_3D()` function and parse the arguments as shown in the code block below.

---
title: Processing NECTA Results in R
author: Masumbuko Semba
date: '2020-06-14'
slug: processing-necta-results-in-r
categories:
...
load("e:/blogs/draft post/necta19.RData")
...
```{r}
grade.location %>% drop_na() %>% group_by(subject) %>% slice(1,n())
```
